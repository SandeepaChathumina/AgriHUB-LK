  ...
  useEffect(() => {
    ...
    if (user?.role !== 'Transporter') {
      Swal.fire({
        icon: 'error',
        title: 'Access Denied',
        text: 'Only transporters can add vehicles',
  ...
  const fetchTransporterId = async () => {
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Failed to load transporter profile',
        confirmButtonColor: '#10b981'
      });
      navigate('/dashboard');
    }
  ...
  const uploadImages = async () => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Uploaded!',
        text: `${data.images.length} images uploaded successfully`,
        confirmButtonColor: '#10b981',
        timer: 2000
      });
      return data.images;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Success!',
        text: `Vehicle ${data.data.vehicle.vehicleId} has been added successfully`,
        confirmButtonColor: '#10b981'
      });
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600">Register a new vehicle to your fleet</p>
            </div>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., Toyota, Tata, Ashok Leyland"
                    className="mt-1 w-full rounded-xl border border-emerald-200 px-4 py-2 focus:border-emerald-500 focus:outline-none"
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., Hilux, Super Ace, 407"
                    className="mt-1 w-full rounded-xl border border-emerald-200 px-4 py-2 focus:border-emerald-500 focus:outline-none"
                    required
                  />
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., 40 Sri 1234 or WP-LB-4321"
                    className="mt-1 w-full rounded-xl border border-emerald-200 px-4 py-2 focus:border-emerald-500 focus:outline-none"
                    required
                  />
            ...
            <div className="flex gap-4">
              ...
              >
                {loading ? 'Adding Vehicle...' : uploadingImages ? 'Uploading Images...' : 'Add Vehicle'}
              </button>
              <button
                type="button"
                onClick={() => navigate('/vehicles')}
