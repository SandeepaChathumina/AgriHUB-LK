    ...
    {!first && (
      <div
        style={{
          height: 1,
          background:
            "linear-gradient(90deg, transparent 0%, #d1fae5 20%, #a7f3d0 50%, #d1fae5 80%, transparent 100%)",
          marginBottom: 48,
        }}
      />
    )}
...
const ImpactAnalytics = () => {
  ...
  useEffect(() => {
    ...
    link.rel = "stylesheet";
    link.href =
      "https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700;9..40,800&family=Lora:wght@600;700&display=swap";
  ...
  const fetchStats = async () => {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/api/admin/impact-stats`,
        {
  ...
  const sdgStats = [
    {
      ...
      rawValue: stats?.totalFoodDistributed || 0,
      suffix: " kg",
      color: "#15803d",
      icon: "🌾",
      delay: 0,
    },
    {
      ...
      rawValue: stats?.completedDeliveries || 0,
      suffix: "",
      color: "#0284c7",
      icon: "🚚",
      delay: 80,
    },
    {
      ...
      rawValue: stats?.activeFarmers || 0,
      suffix: "",
      color: "#d97706",
      icon: "👨‍🌾",
      delay: 160,
          ...
          <div className="ia-hero">
            ...
            <div
              ...
              style={{
                ...
                bottom: -50,
                left: 80,
                animation: "ia-float 8s ease-in-out infinite 1s",
              }}
            />
            <div
              className="ia-hero-blob"
              style={{
                ...
                top: 20,
                right: 200,
                animation: "ia-float 5s ease-in-out infinite 0.5s",
              }}
            />
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p className="ia-hero-desc">
                ...
                measuring real progress toward{" "}
                <strong style={{ color: "#fff" }}>
                  SDG Goal 2: Zero Hunger
                </strong>{" "}
                through order flow, delivery performance, and platform-wide
                coordination.
              </p>
              <div
                style={{
              ...
              <Section delay={180}>
                ...
                >
                  {orderCards.map((c, i) => (
                    <div
                      key={c.label}
                      className="ia-card ia-order-card"
                      style={{ animationDelay: `${i * 60}ms` }}
                    >
                      <p className="ia-order-label">{c.label}</p>
                      <p className="ia-order-value" style={{ color: c.color }}>
                        {c.value}
                      </p>
                    </div>
                  ))}
                ...
                >
                  <div className="ia-card ia-insight-card">
                    ...
                    <p className="ia-insight-body">
                      ...
                      distributors, and transporters. By tracking fulfilled
                      orders and food distribution, the platform provides
                      measurable evidence of its contribution toward reducing
                      food access challenges across Sri Lanka.
                    </p>
                  </div>

                  <div
                    className="ia-card ia-insight-card"
                    style={{
                  ...
                  >
                    ...
                    <p className="ia-insight-body">
                      This system contributes directly to{" "}
                      <strong style={{ color: "#15803d" }}>
                        SDG Goal 2: Zero Hunger
                      </strong>{" "}
                      by helping food move more efficiently from producers to
                      distribution points. Better order handling, farmer
                      approval workflows, and delivery tracking reduce delays
                      and strengthen the national food supply chain.
                    </p>
                  </div>
                </div>
              </Section>
